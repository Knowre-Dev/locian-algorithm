...
function test_result(function_name, answer, input) {
    var tree_answer = LatexToTree(answer);
    tree_answer = function_name(tree_answer);
    var tree_input = LatexToTree(input);
